package com.wangbin.ai.framework.websocket.config;

import com.wangbin.ai.framework.mq.redis.config.DABINRedisMQConsumerAutoConfiguration;
import com.wangbin.ai.framework.mq.redis.core.RedisMQTemplate;
import com.wangbin.ai.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.wangbin.ai.framework.websocket.core.listener.WebSocketMessageListener;
import com.wangbin.ai.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.wangbin.ai.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.wangbin.ai.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.wangbin.ai.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.wangbin.ai.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.wangbin.ai.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.wangbin.ai.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.wangbin.ai.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.wangbin.ai.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.wangbin.ai.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.wangbin.ai.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.wangbin.ai.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.wangbin.ai.framework.websocket.core.session.WebSocketSessionManager;
import com.wangbin.ai.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class DABINWebSocketAutoConfiguration {
    ...
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${DABIN.websocket.sender-rocketmq.topic}") String topic) {
    ...
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${DABIN.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${DABIN.websocket.sender-kafka.topic}") String topic) {
