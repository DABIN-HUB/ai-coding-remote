package com.wangbin.ai.module.infra.service.logger;
...
import com.wangbin.ai.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.wangbin.ai.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.wangbin.ai.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.wangbin.ai.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.wangbin.ai.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.wangbin.ai.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("DABIN-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("DABIN-test");
