package com.wangbin.ai.module.system.controller.admin.socail.vo.client;
...
import com.wangbin.ai.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "DABIN商城")
