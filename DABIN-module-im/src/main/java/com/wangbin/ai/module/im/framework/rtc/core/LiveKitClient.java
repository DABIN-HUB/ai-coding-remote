package com.wangbin.ai.module.im.framework.rtc.core;
 ...
 * <p>
 * 由 {@link com.wangbin.ai.module.im.framework.rtc.config.ImRtcConfiguration} 注册为 Bean，本类不带 {@code @Component}
 *
 * @author 芋道源码
 */
@Slf4j
