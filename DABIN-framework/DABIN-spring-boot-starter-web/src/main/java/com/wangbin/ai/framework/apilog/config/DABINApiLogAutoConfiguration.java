package com.wangbin.ai.framework.apilog.config;

import com.wangbin.ai.framework.apilog.core.filter.ApiAccessLogFilter;
import com.wangbin.ai.framework.apilog.core.interceptor.ApiAccessLogInterceptor;
...
@AutoConfiguration(after = DABINWebAutoConfiguration.class)
public class DABINApiLogAutoConfiguration implements WebMvcConfigurer {
