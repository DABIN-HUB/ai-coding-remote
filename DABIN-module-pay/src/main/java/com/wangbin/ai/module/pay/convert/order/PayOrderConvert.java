package com.wangbin.ai.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.wangbin.ai.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
