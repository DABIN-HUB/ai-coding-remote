package com.wangbin.ai.module.ai.service.chat;
...
import com.wangbin.ai.framework.tenant.core.util.TenantUtils;
import com.wangbin.ai.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.wangbin.ai.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.wangbin.ai.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.wangbin.ai.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.wangbin.ai.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.wangbin.ai.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.wangbin.ai.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.wangbin.ai.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.wangbin.ai.module.ai.dal.dataobject.model.AiModelDO;
import com.wangbin.ai.module.ai.dal.dataobject.model.AiToolDO;
import com.wangbin.ai.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.wangbin.ai.module.ai.enums.ErrorCodeConstants;
import com.wangbin.ai.module.ai.enums.model.AiPlatformEnum;
import com.wangbin.ai.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.wangbin.ai.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.wangbin.ai.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.wangbin.ai.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.wangbin.ai.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.wangbin.ai.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.wangbin.ai.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.wangbin.ai.module.ai.service.model.AiChatRoleService;
import com.wangbin.ai.module.ai.service.model.AiModelService;
import com.wangbin.ai.module.ai.service.model.AiToolService;
import com.wangbin.ai.module.ai.util.AiUtils;
import com.wangbin.ai.module.ai.util.FileTypeUtils;
...
import static com.wangbin.ai.framework.common.pojo.CommonResult.error;
...
import static com.wangbin.ai.framework.common.util.collection.CollectionUtils.convertSet;
import static com.wangbin.ai.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.wangbin.ai.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 DABIN.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 DABIN.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
