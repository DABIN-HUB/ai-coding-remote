package com.wangbin.ai.framework.tenant.core.security;
...
import com.wangbin.ai.framework.web.core.filter.ApiRequestFilter;
...
public class TenantSecurityWebFilter extends ApiRequestFilter {
     ...
     * 允许忽略租户的 URL 列表
     *
     * 目的：解决 <a href="https://gitee.com/zhijiantianya/DABIN-cloud/issues/ICUQL9">修改配置会导致 @TenantIgnore Controller 接口过滤失效</>
     */
