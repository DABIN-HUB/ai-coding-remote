...
@Schema(description = "管理后台 - Agent Session Interrupt Request VO")
@Data
public class AgentSessionInterruptReqVO {
    ...
    @Schema(description = "需要中断的 Prompt Command 业务编号", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank
    @Size(max = 64)
