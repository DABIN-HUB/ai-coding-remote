package com.wangbin.ai.framework.tenant.config;

import com.wangbin.ai.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.wangbin.ai.framework.security.core.service.SecurityFrameworkService;
import com.wangbin.ai.framework.tenant.core.aop.TenantIgnore;
import com.wangbin.ai.framework.tenant.core.aop.TenantIgnoreAspect;
import com.wangbin.ai.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.wangbin.ai.framework.tenant.core.job.TenantJobAspect;
import com.wangbin.ai.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.wangbin.ai.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.wangbin.ai.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.wangbin.ai.framework.tenant.core.redis.TenantRedisCacheManager;
import com.wangbin.ai.framework.tenant.core.security.TenantSecurityWebFilter;
import com.wangbin.ai.framework.tenant.core.service.TenantFrameworkService;
import com.wangbin.ai.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.wangbin.ai.framework.tenant.core.web.TenantContextWebFilter;
import com.wangbin.ai.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class DABINTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.wangbin.ai.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     DABINCacheProperties DABINCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(DABINCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.wangbin.ai.framework.quartz.core.handler.JobHandler")
