package com.wangbin.ai.framework.ratelimiter.config;

import com.wangbin.ai.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.wangbin.ai.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.wangbin.ai.framework.ratelimiter.core.keyresolver.impl.*;
import com.wangbin.ai.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class DABINRateLimiterConfiguration {
