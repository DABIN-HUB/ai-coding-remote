package com.wangbin.ai.module.infra.controller.admin.job.vo.log;
...
import com.wangbin.ai.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "DABIN")
