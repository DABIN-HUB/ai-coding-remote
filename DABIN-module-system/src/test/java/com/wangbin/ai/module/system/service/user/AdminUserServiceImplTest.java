package com.wangbin.ai.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.wangbin.ai.framework.common.enums.CommonStatusEnum;
import com.wangbin.ai.framework.common.exception.ServiceException;
import com.wangbin.ai.framework.common.pojo.PageResult;
import com.wangbin.ai.framework.common.util.collection.ArrayUtils;
...
import com.wangbin.ai.module.infra.api.config.ConfigApi;
import com.wangbin.ai.module.infra.api.file.FileApi;
import com.wangbin.ai.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.wangbin.ai.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.wangbin.ai.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.wangbin.ai.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.wangbin.ai.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.wangbin.ai.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.wangbin.ai.module.system.dal.dataobject.dept.DeptDO;
import com.wangbin.ai.module.system.dal.dataobject.dept.PostDO;
import com.wangbin.ai.module.system.dal.dataobject.dept.UserPostDO;
import com.wangbin.ai.module.system.dal.dataobject.tenant.TenantDO;
import com.wangbin.ai.module.system.dal.dataobject.user.AdminUserDO;
import com.wangbin.ai.module.system.dal.mysql.dept.UserPostMapper;
import com.wangbin.ai.module.system.dal.mysql.user.AdminUserMapper;
import com.wangbin.ai.module.system.enums.common.SexEnum;
import com.wangbin.ai.module.system.mq.producer.user.AdminUserProducer;
import com.wangbin.ai.module.system.service.dept.DeptService;
import com.wangbin.ai.module.system.service.dept.PostService;
import com.wangbin.ai.module.system.service.oauth2.OAuth2TokenService;
import com.wangbin.ai.module.system.service.permission.PermissionService;
import com.wangbin.ai.module.system.service.tenant.TenantService;
...
import static com.wangbin.ai.framework.common.util.collection.SetUtils.asSet;
import static com.wangbin.ai.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.wangbin.ai.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.wangbin.ai.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.wangbin.ai.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.wangbin.ai.framework.test.core.util.AssertUtils.assertServiceException;
import static com.wangbin.ai.framework.test.core.util.RandomUtils.*;
import static com.wangbin.ai.module.system.enums.ErrorCodeConstants.*;
import static com.wangbin.ai.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("DABINyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("DABINyuanma");
        ...
        assertEquals("DABINyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("DABINyuanma"))).thenReturn("java");
