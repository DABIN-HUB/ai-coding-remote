...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.wangbin.ai";
    private static final String ARTIFACT_ID = "DABIN";
    private static final String PACKAGE_NAME = "com.wangbin.ai";
    private static final String TITLE = "DABIN ai管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.wangbin.ai";
        String artifactIdNew = "DABIN";
        String packageNameNew = "com.wangbin.ai";
        String titleNew = "DABIN ai管理系统";
