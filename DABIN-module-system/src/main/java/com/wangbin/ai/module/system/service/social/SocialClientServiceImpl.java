package com.wangbin.ai.module.system.service.social;
...
import com.wangbin.ai.framework.common.util.cache.CacheUtils;
import com.wangbin.ai.framework.common.util.http.HttpUtils;
import com.wangbin.ai.framework.common.util.object.BeanUtils;
import com.wangbin.ai.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.wangbin.ai.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.wangbin.ai.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.wangbin.ai.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.wangbin.ai.module.system.dal.dataobject.social.SocialClientDO;
import com.wangbin.ai.module.system.dal.mysql.social.SocialClientMapper;
import com.wangbin.ai.module.system.dal.redis.RedisKeyConstants;
import com.wangbin.ai.module.system.enums.social.SocialTypeEnum;
import com.wangbin.ai.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.wangbin.ai.framework.common.util.collection.MapUtils.findAndThen;
import static com.wangbin.ai.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.wangbin.ai.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${DABIN.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${DABIN.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/DABIN-cloud/pulls/230
