package com.wangbin.ai.module.ai.framework.ai.core.model;
...
import com.wangbin.ai.module.ai.framework.ai.config.AiAutoConfiguration;
import com.wangbin.ai.module.ai.framework.ai.config.DABINAiProperties;
...
import com.wangbin.ai.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.wangbin.ai.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            DABINAiProperties.Midjourney properties = SpringUtil.getBean(DABINAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        DABINAiProperties.YiYan properties = new DABINAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(DABINAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        DABINAiProperties.Gemini properties = SpringUtil.getBean(DABINAiProperties.class)
    ...
    private GrokChatModel buildGrokChatModel(String apiKey, String url) {
        DABINAiProperties.Grok properties = new DABINAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
